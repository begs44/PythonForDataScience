...
########################################
# Görev 1: Veri Seti İncelemesi ve Temel Sorular
########################################
...
########################################
# Görev 2: Çeşitli Kırılımlarda Ortalama Kazançlar
########################################
...
########################################
# Görev 4: İndeks İsimlerini Değişkene Çevirme
########################################
# Üçüncü sorunun çıktısında yer alan PRICE dışındaki tüm değişkenler index isimleridir.
# Bu isimleri değişken isimlerine çeviriniz. (İpucu: reset_index())
...
########################################
# Görev 6: Level Based Müşterileri Tanımlama
########################################
...
# Amacımıza bir adım daha yaklaştık. Burada ufak bir problem var. Birçok aynı segment olacak.
# örneğin USA_ANDROID_MALE_0_18 segmentinden birçok sayıda olabilir, kontrol edelim:
...
########################################
# Görev 7: Segmentlere Ayırma
########################################
# Yeni müşterileri segmentlere ayırınız.
# PRICE'a göre segmentlere ayırınız,
# segmentleri "SEGMENT" isimlendirmesi ile agg_df'e ekleyiniz ve betimleyiniz,
...
########################################
# Görev 8: Sınıflandırma ve Tahmin
########################################
