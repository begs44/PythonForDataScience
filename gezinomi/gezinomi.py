...
#
# Örneğin: Antalya'dan Her Şey Dahil bir otele yoğun bir dönemde gitmek isteyen bir müşterinin
...
########################################
# Görev 2: EB_Score Değişkeni Oluşturma
########################################
...
########################################
# Görev 3: Çeşitli Kırılımlarda Ücret Ortalamaları
########################################
...
########################################
# Görev 4: Çıktıyı Price'a Göre Sıralama
########################################
...
########################################
# Görev 5: İndeks İsimlerini Değişkene Çevirme
########################################
...
########################################
# Görev 6: Level Based Satışları Tanımlama
########################################
...
########################################
# Görev 7: Personaları Segmentlere Ayırma
########################################
