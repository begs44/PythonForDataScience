##################################################
# FONKSİYONLARA ÖZELLİK VE DOCSTRING EKLEME
##################################################
...
# Var olan özelliği de argümandan kontrol edilebilir hale getirebilirsiniz.
...
# ÖNCESİ
def check_df_old(dataframe, head=5):
    print("##################### Shape #####################")
...
##############################
# cat_summary() için ratio özelliği
##############################

# ÖNCESİ
def cat_summary_old(dataframe, col_name, plot=False):
...
########################################
# Görev 2: Docstring Yazma
########################################
# cat_summary() ve check_df() fonksiyonuna docstring yazınız.
