...
students = ["John", "Mark", "Vanessa", "Daisy"]
...
# after: "Hi mY NaMe iS JoHn aNd i aM LeArNiNg pYtHoN" (çift indeks büyük)

range(len("bengü"))
range(0, 5)

for i in range(len("bengü")):
    print(i)
...
########################################
# Enumerate: Otomatik Counter/Indexer İle For Loop
########################################
...
##############################
# İsminde "INS" olan değişkenlere flag eklemek
##############################
...
##############################
# Sayısal değişkenler için sözlük oluşturmak
##############################
# Amaç key'i string, value'su agg_list listesi olan sözlük oluşturmak.
